...
export default function ProjectDetailPage({ params }: { params: { slug: string, lang: string } }) {
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="relative h-96 rounded-2xl overflow-hidden mb-8">
          <Image
            ...
            alt={project.title[params.lang as 'fa' | 'en']}
            fill
        ...
        <h1 className="text-4xl font-bold mb-4">
          {project.title[params.lang as 'fa' | 'en']}
        </h1>
        <p className="text-xl text-[rgb(var(--text-secondary))] mb-8">
          {project.description[params.lang as 'fa' | 'en']}
        </p>
        ...
        <div className="mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            {project.features[params.lang as 'fa' | 'en'].map((feature, idx) => (
